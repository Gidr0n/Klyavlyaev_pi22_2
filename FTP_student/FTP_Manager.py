...
import shutil
import os
from FTP_Setting import folder_path as main_folder
from FTP_Setting import log_path as log_path
from FTP_Setting import User_path as User_path 
...
def main(stdscr):
    ...
    with open(User_path, 'r') as filea:
        user_name = filea.read().strip()  # Убираем лишние пробелы и символы переноса строки
